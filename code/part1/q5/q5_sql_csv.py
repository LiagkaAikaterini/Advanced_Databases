...
res.coalesce(1).write.mode('overwrite').format('com.databricks.spark.csv').save("hdfs://master:9000/outputs/q5_sql_csv.csv")

res.show(30)
end_time = time.time()
total_time = end_time - start_time
print("Total execution time for Query 5 (Spark SQL - csv format) is: " + str(total_time) + " sec\n")
