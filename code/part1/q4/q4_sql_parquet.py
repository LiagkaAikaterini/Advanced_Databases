...
res.coalesce(1).write.mode('overwrite').format('com.databricks.spark.csv').save("hdfs://master:9000/outputs/q4_sql_parquet.csv")

res.show()
end_time = time.time()
total_time = end_time - start_time
print("Total execution time for Query 4 (Spark SQL - parquet format) is: " + str(total_time) + " sec\n")
